...
@$idpelaksanaan=$_POST["idpelaksanaan"];
//echo $idpelaksanaan;
...
$data=mysql_fetch_array(mysql_query("select P.ID_PELAKSANAAN, P.NAMA_PELAKSANAAN, pe.ID_PERIODE, pe.NAMA_PERIODE, P.BATAS_AWAL, P.BATAS_AKHIR from pelaksanaan_yudisium p, periode pe where p.id_periode=pe.id_periode and id_pelaksanaan='$idpelaksanaan'"));
                        ...
                        <div class="block" >
                            ...
                            <div class="block-content collapse in">
                                <div class="row-fluid padd-bottom">
                                  <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal" method="POST" action="proses-input-editpelaksanaan.php" enctype="multipart/form-data" autocomplete="off">
                                      <fieldset>
                                        <legend align="center">Edit Data Pelaksanaan Yudisium</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">ID Pelaksanaan</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="idpelaksanaan" value="<?php echo $data[0]; ?>" data-provide="typeahead"  placeholder="ID Pelaksanaan Yudisium" readonly>
										...
										{ 
										if($data[2]==$array1[0]){ ?>
										<option value="<?php echo $array1["ID_PERIODE"]; ?>" selected><?php echo $array1["NAMA_PERIODE"]; ?></option>
										<?php  
										} else {
										?>
										<option value="<?php echo $array1["ID_PERIODE"]?>"> <?php echo $array1["NAMA_PERIODE"] ?></option>
										<?php
										}
										} ?>
										</select>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="namapelaksanaan" value="<?php echo $data[1]; ?>" data-provide="typeahead" data-items="4" placeholder="Nama Pelaksanaan Yudisium" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="date" class="span6 tglmulai" id="tglmulai" name="tglpelaksanaan" value="<?php echo $data[4]; ?>" data-provide="typeahead"  onchange="minimal()" required >
                                          </div>
                                        </div>
										 <div class="control-group">
                                          <label class="control-label" for="typeahead">Batas Akhir</label>
                                          <div class="controls">
                                            <input type="date" class="span6 tglselesai"  id="tglselesai" name="batas" value="<?php echo $data[5]; ?>" data-provide="typeahead" required >
                                          </div>
                                        </div>
