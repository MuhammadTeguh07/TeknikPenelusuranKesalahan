...
$data=mysql_fetch_array(mysql_query("SELECT P.ID_PRODI, P.NAMA_PRODI, D.ID_DEPARTEMEN, D.NAMA_DEPARTEMEN from PROGRAM_STUDI P, DEPARTEMEN D where
P.ID_DEPARTEMEN=D.ID_DEPARTEMEN AND ID_PRODI='$id_prodi'"));
$prodi=$data[1];
                                     ...
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="id_prodi" value="<?php echo $data[0];?>" data-provide="typeahead"  value="" placeholder="" readonly>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nama_prodi" value="<?php echo $prodi;?>" data-provide="typeahead" data-items="4" placeholder="<?php echo $data[1];?>" required>
										...
										<div class="controls">
										<select name="id_departemen" id="select01" class="span6 chzn-select" required>
										...
										<?php
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											if(isset($id_departemen,$nama_prodi,$id_prodi))
											{
											mysql_query("update PROGRAM_STUDI set ID_DEPARTEMEN='$id_departemen', NAMA_PRODI='$nama_prodi' where ID_PRODI='$id_prodi'");
