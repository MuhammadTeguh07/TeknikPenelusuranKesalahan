            ...
            <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i>Tata Usaha<i class="caret"></i>
					...
					<div class="row-fluid">
                        ...
                        <div class="block" >
                            <div class="navbar navbar-inner block-header" >
                                <div class="muted pull-left" ><strong>Validasi Berkas</strong></div>    
                            </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
						              ...
						              <tbody>
						                <tr>
						                  <td>151411513067</td>
						                  <td>Rizki Abdeu Darise</td>
						                  <td>Formulir Data Mahasiswa</td>
						                  <td>form.pdf</td>
										  <td>
										   <button class="btn"><i class="icon-eye-open"></i> View</button></td>
										  <td>
										  <button class="btn"><a href="#" class="icon-ok"></a> Yes</button>
										  </td>
										  <td>
										  <button class="btn"><a href="#" class="icon-remove"></a> No</button>
