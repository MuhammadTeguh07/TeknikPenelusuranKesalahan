...
$data=mysql_fetch_array(mysql_query("SELECT ID_BERKAS, NAMA_BERKAS, KETERANGAN from BERKAS_YUDISIUM where
ID_BERKAS='$id_berkas'"));
$ber=$data[1];
$ket=$data[2]
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        <legend>Data Berkas Yudisium</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">ID Berkas Yudisium</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="id_berkas" value="<?php echo $data[0];?>" data-provide="typeahead"  value="" placeholder="ID Jabatan" readonly>
											
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">Nama Berkas Yudisium</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nama_berkas" value="<?php echo $ber;?>" data-provide="typeahead" data-items="4" placeholder="<?php echo $data[1];?>" required>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="ket" value="<?php echo $ket;?>" data-provide="typeahead" data-items="4" placeholder="<?php echo $data[2];?>" required>
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											{
											mysql_query("update berkas_yudisium set NAMA_BERKAS='$nama_berkas', KETERANGAN='$ket' where ID_BERKAS='$id_berkas'");
