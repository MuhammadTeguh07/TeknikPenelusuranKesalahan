...
$data=mysql_fetch_array(mysql_query("SELECT ID_JABATAN, NAMA_JABATAN from JABATAN where
                                     ...
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="id_jabatan" value="<?php echo $data[0];?>" data-provide="typeahead"  value="" placeholder="ID Jabatan" readonly>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nama_jabatan" value="<?php echo $jab;?>" data-provide="typeahead" data-items="4" placeholder="<?php echo $data[1];?>" required>
