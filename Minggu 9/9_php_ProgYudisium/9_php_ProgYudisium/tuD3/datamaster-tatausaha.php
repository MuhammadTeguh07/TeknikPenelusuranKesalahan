            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					<div class="row-fluid">
                        ...
                        <div class="block" >
										<?php
										$dataa=mysql_fetch_array(mysql_query("select count(id_peg) as jumlah from tata_usaha;"));
										?>
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        <legend align="center">Data Tata Usaha</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">NIP</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nip" data-provide="typeahead" onkeypress='validate(event)'  placeholder="NIP" required>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nama_tu" data-provide="typeahead" data-items="4" placeholder="Nama Lengkap" required>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="password" class="span6" id="typeahead" name="pass" data-provide="typeahead" data-items="4" placeholder="Password" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                         <label class="control-label" for="date01">Tanggal Lahir</label>
                                          <div class="controls">
                                            <input type="date" required class="span6" id="typeahead"  data-provide="typeahead" name="tgl_lahir"  >
                                          </div>
                                        </div>
										<div class="control-group">
                                         <label class="control-label" for="date01">Alamat</label>
                                          <div class="controls">
                                            <input type="text" required class="span6" id="typeahead"  data-provide="typeahead" name="alamat" placeholder="Alamat" >
                                          </div>
                                        </div>
										<div class="control-group">
                                          <label class="control-label" for="typeahead">No. Telp</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="telp" data-provide="typeahead" onkeypress='validate(event)' data-items="4" placeholder="No. Telp" required>
                                          </div>
                                        </div>
										 <div class="control-group">
                                          <label class="control-label" required >Jenis Kelamin</label>
										...
										<div class="form-actions">
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											if(isset($nip,$nama_tu,$pass))
											{
											mysql_query("insert into tata_usaha values ('$nip','$id_kota','$id_prodi','$pass','$nama_tu','$tgl_lahir','$alamat','$telp','$jk','$email')");
											echo "<script>alert('Berhasil!!!!!!!!');</script>";
											echo("<META HTTP-EQUIV=\"Refresh\"CONTENT=\"2;URL=datamaster-tatausaha.php\">");
											...
											<legend></legend>
									<fieldset>
                                        <legend ALIGN="CENTER">Daftar Tata Usaha</legend>
										
										
								<div class="block-content collapse in">
                                <div class="span12">
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
									<form method="POST" action="datamaster-tatausaha-edit.php" >
						              <thead  align="center">
						                <tr >
						                  <th>NIP</th>
						                  <th>Nama Lengkap</th>
...
$str=mysql_query("SELECT T.ID_PEG, T.NAMA_PEG, P.NAMA_PRODI, K.NAMA_KOTA, T.TGL_LAHIR_TU, T.ALAMAT, T.NO_TELP, T.EMAIL
FROM TATA_USAHA T, PROGRAM_STUDI P, KOTA K
WHERE P.ID_PRODI=T.ID_PRODI AND K.ID_KOTA=T.ID_KOTA");
while($data=mysql_fetch_array($str))
{
	$format = date('d-m-Y', strtotime($data[4]));
echo
"<tbody><tr><td>".$data[0]."</td><td>".$data[1]."</td><td>".$data[2]."</td><td>".$data[3]."</td><td>".$format."</td><td>".$data[5]."</td><td>".$data[6]."</td><td>".$data[7]."</td>" ?>

<td><button class="btn btn-info btn-mini" type="submit" name="id_tu" value="<?php echo $data[0]; ?>">Edit</button>
