					...
					<div class="row-fluid">
                        ...
                        <div class="block" >
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
											<legend></legend>
											<legend ALIGN="CENTER">Import Data Dosen</legend>
											<form class="form-horizontal" method="POST" action="importdatadosen.php" enctype="multipart/form-data">
											<table width="40%" border="0">
											<?php $file="dosen.xlsx"; ?>
											<tr height="10px">
											<td>Format Import Data Dosen</td>
											
											<td><a href="../berkasdownload/format-dosen.php?nama=<?php echo @$file; ?>" class="btn btn-info btn-mini" ><i class="icon-download"></i> Download</a></td>
											</tr>
											</table><br>			
											
											<label class="control-label" for="typeahead">Import Data Dosen</label>
										<div class="controls">
										...
										<strong>Data Dosen Berhasil Disimpan</strong> .
									</div>';
										} else if($pesan==2) {
										...
										?>
									<fieldset>
                                        <legend ALIGN="CENTER">Daftar Data Dosen</legend>
                                 ...
                                 <div class="span12">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                        ...
                                        <tbody>
                                            <?php
									  $no=1;
$str=mysql_query("SELECT D.NIP, D.NAMA_DOSEN, K.NAMA_KOTA, D.TGL_LAHIR_DOSEN, D.JK, D.EMAIL
								from dosen d, fakultas f, departemen dd, program_studi p, kota k
								where f.ID_FAKULTAS=dd.ID_FAKULTAS AND dd.ID_DEPARTEMEN=p.ID_DEPARTEMEN AND  D.ID_KOTA=K.ID_KOTA group by d.nip asc");
while($data=mysql_fetch_array($str))
{
	$format = date('d-m-Y', strtotime($data[3]));
echo
"<tr><td>".$no.".</td><td>".$data[0]."</td><td>".$data[1]."</td><td>".$data[2].", ".$format."</td><td>".$data[4]."</td><td>".$data[5]."</td>" ?>

<td><a href="datamaster-dosen-edit.php?nip=<?php echo $data[0]; ?>" class="btn btn-info btn-mini" >Edit</a>
<?php echo "</td></tr>" ;
$no++;
}
?>
