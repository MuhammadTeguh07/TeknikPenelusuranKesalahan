...
WHERE K.ID_KOTA=T.ID_KOTA AND P.ID_PRODI=T.ID_PRODI AND T.ID_PEG='$idtu'";
$b2 = mysql_query($b4);
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        <legend align="center">Edit Tata Usaha</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">NIP</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nip" data-provide="typeahead" onkeypress='validate(event)' value="<?php echo $idtu1;?>"  placeholder="NIP" required>
										...
										<div class="form-actions">
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											{
											mysql_query("UPDATE TATA_USAHA SET ALAMAT = '$alamat', NAMA_PEG = '$nama_tu', ID_PRODI = '$id_prodi', ID_KOTA = '$id_kota', TGL_LAHIR_TU = '$tgl_lahir', NO_TELP = '$telp' , JK = '$jk', EMAIL = '$email' WHERE ID_PEG = '$idtu';");
											echo "<script>alert('Berhasil!!!!!!!!');</script>";
											echo("<META HTTP-EQUIV=\"Refresh\"CONTENT=\"0;URL=datamaster-tatausaha.php\">");
