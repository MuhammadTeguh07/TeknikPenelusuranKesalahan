...
$a = "SELECT MAX(ID_DEPARTEMEN) FROM departemen";
								$b = mysql_query($a);
								...
								$dept = substr($max, 1, 4);
								$dept = $dept + 1;
								if($dept <= 9) $dept = "d000".$dept;
								if($dept <= 99 && $dept > 9) $dept = "d00".$dept;
								if($dept <= 999 && $dept > 99) $dept = "d0".$dept;
								if($dept <= 9999 && $dept > 999) $dept = "d".$dept;
?>
<html class="no-js">
            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					<div class="row-fluid">
                        <!-- block -->
										<?php
										$dataa=mysql_fetch_array(mysql_query("select count(id_departemen) as jumlah from departemen;"));
										?>
                        <div class="block" >
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        <legend align="center">Data Departemen</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">ID Departemen</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="id_dept" value="<?php echo $dept; ?>" data-provide="typeahead"  placeholder="ID Fakultas" readonly>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nama_dept" data-provide="typeahead" data-items="4" placeholder="Nama Departemen" required >
										...
										<div class="controls">
										<select name="namafak" id="select01" class="span6 chzn-select" required>
										...
										<?php
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											<?php 
												...
												@$nama_dept=$_REQUEST['nama_dept'];
												@$namafak=$_REQUEST['namafak'];
											if(isset($id_dept,$nama_dept,$namafak))
											{
											mysql_query("insert into departemen values ('$id_dept','$namafak','$nama_dept')");
						
											echo "<script>alert('Berhasil!!!!!!!!');</script>";
	
										echo("<META HTTP-EQUIV=\"Refresh\"CONTENT=\"2;URL=datamaster-departemen.php\">");
											...
											<legend></legend>
									<fieldset>
                                        <legend align="center">Daftar Departemen</legend>
								<div class="block-content collapse in">
                                <div class="span12">
								<form method="POST" action="datamaster-departemen-edit.php" >
						              ...
						              <?php
									  $no=1;
$str=mysql_query("SELECT D.ID_DEPARTEMEN, F.NAMA_FAKULTAS, D.NAMA_DEPARTEMEN from departemen d, fakultas f where f.id_fakultas=d.id_fakultas");
while($data=mysql_fetch_array($str))
{
echo
"<tr><td>".$no.".</td><td>".$data[0]."</td><td>".$data[1]."</td><td>".$data[2]."</td>" ?>

<td><button class="btn btn-info btn-mini" name="id_departemen" value="<?php echo $data[0]; ?>">Edit</button>
<?php echo "</td></tr>" ;
$no++;
}
?>
