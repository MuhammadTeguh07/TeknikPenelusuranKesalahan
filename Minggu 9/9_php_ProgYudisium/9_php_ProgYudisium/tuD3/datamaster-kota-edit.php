...
$data=mysqli_fetch_array(mysqli_query($kon, "SELECT ID_KOTA, NAMA_KOTA from kota where
ID_KOTA='$idkota'"));
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        <legend align="center">Edit Data Kota</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">ID Kota</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="id_kota" value="<?php echo $data[0];?>" data-provide="typeahead"  value="" placeholder="ID Kota" readonly>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nama_kota" value="<?php echo $namakota;?>" data-provide="typeahead" data-items="4" placeholder="" required>
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											{
											mysqli_query($kon, "UPDATE kota set NAMA_KOTA='$nama_kota' where ID_KOTA='$id_kota'");
											echo "<script>alert('Berhasil!!!!!!!!');</script>";
											echo("<META HTTP-EQUIV=\"Refresh\"CONTENT=\"0;URL=datamaster-kota.php\">");
