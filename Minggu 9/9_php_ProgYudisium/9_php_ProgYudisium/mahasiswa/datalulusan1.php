    ...
    <body>
                ...
                <div class="span9" id="content">
					...
					<div class="row-fluid">
                        ...
                        <div class="block">
							...
							<?php
								$deu4 = "SELECT P.ID_PENDAFTARAN, P.TANGGAL_DITERIMA, M.AGAMA, P.NAMA_ORTU, P.PEKERJAAN, P.JUDUL_TA, P.IPK, P.TOTAL_SKS,  P.TGL_DAFTAR, P.SKOR_ELPT, P.PRESENTASE_NILAI_D, P.NILAI_SKP, P.TANGGAL_UJIAN_TA, P.LULUS_PPKMB FROM PENDAFTARAN P, MAHASISWA M WHERE M.NIM=P.NIM AND P.ID_PENDAFTARAN='$pendf'";
		...
		<br><br> -->
                                      ...
                                      <fieldset>
										...
										<div class="control-group">
										<label class="control-label" for="select03" >Agama</label>
										<div class="controls"]>
										<select name="agama" id="select03" class="span6 chzn-select" required>
										<option value="Islam" <?php if($deu[2]=="Islam"){ echo "selected";} else { echo "";} ?>>Islam</option>
										<option value="Kristen" <?php if($deu[2]=="Kristen"){ echo "selected";} else { echo "";} ?>>Kristen</option>
										<option value="Khatolik" <?php if($deu[2]=="Katholik"){ echo "selected";} else { echo "";} ?>>Khatolik</option>
										<option value="Hindu" <?php if($deu[2]=="Hindu"){ echo "selected";} else { echo "";} ?>>Hindu</option>
										<option value="Buddha" <?php if($deu[2]=="Buddha"){ echo "selected";} else { echo "";} ?>>Buddha</option>
										</select>
										</div></div>
										<div class="control-group">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="total" value="<?php echo $deu[7]; ?>" onkeypress='validate(event)' data-provide="typeahead" data-items="4" maxlength="3" placeholder="Total SKS" required>
                                          </div>
                                        </div>
										<div class="control-group" id="control2">
                                          <label class="control-label" for="typeahead">Nilai SKP</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="skp" onkeyup="checkskp(); return false;" name="skp" onkeypress='validate(event)' value="<?php echo $deu[11]; ?>" maxlength="4"data-provide="typeahead" data-items="4" placeholder="Nilai SKP" required>
										...
										<div class="control-group" id="control3">
                                          ...
                                          <div class="controls">
                                            <!-- <input type="text" class="span6" id="nilai" onkeyup="checknilai(); return false;" name="nilai" onkeypress='validate(event)' value="<?php //echo $deu[10]; ?>" data-provide="typeahead"  data-items="4" placeholder="" required> 
											
										    -->
										  <input type="text" onkeypress='validate(event)' maxlength="5" class="span1" name="nilaii" id="nilaid" size="7"  value="0" onkeyup="totalan(); return false;" > 
										  
                                            Presentase
										  <input type="text" class="span4" name="nilai" id="totally" value="<?php echo $deu[10]; ?>" maxlength="4" value="" readonly onkeyup="totalan(); return false;" maxlength="3" >
										  %
										...
										<div class="control-group" id="control1">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="elpt" onkeyup="checkelpt(); return false;" name="elpt" onkeypress='validate(event)' placeholder="Skor ELPT" value="<?php echo $deu[9]; ?>" data-provide="typeahead"  data-items="4"  required>
...
function checkskp()
    {
		...
		var jumlah = (nilaid / 110) * 100 ;
		var potong = jumlah.toPrecision(3);
		document.getElementById('totally').value = potong;
