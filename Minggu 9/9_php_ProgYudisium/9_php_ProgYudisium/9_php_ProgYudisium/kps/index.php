                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="block">
								...
								<div class="span12">
								<legend>Daftar Mahasiswa Lulus Yudisium</legend>
								<form method="POST" action="detail-mahasiswa-lulus-yudisium.php" >
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
										...
										<tbody>
                                         <?php
									  @$no=1;
@$str=mysql_query("	select py.nama_pelaksanaan, count(dp.id_pendaftaran), dp.id_pelaksanaan, per.nama_periode, year(py.batas_akhir)
					from pendaftaran pe, pelaksanaan_yudisium py, detail_pelaksanaan dp, periode per
					where pe.id_pendaftaran=dp.id_pendaftaran and py.id_pelaksanaan=dp.id_pelaksanaan and py.id_periode=per.id_periode and dp.status_lulus='1' group by dp.id_pelaksanaan desc");
