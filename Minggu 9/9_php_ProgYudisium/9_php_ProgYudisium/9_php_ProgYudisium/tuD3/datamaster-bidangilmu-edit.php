...
$data=mysql_fetch_array(mysql_query("SELECT B.ID_BIDANGILMU, B.NAMA_BIDANGILMU, P.ID_PRODI, P.NAMA_PRODI from PROGRAM_STUDI P, BIDANGILMU B where
P.ID_PRODI=B.ID_PRODI AND ID_BIDANGILMU='$id_bidang'"));
$bidang=$data[1];
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
                                     <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      <fieldset>
                                        <legend>Data Bidang Ilmu</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">ID Bidang Ilmu</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="id_bidang" value="<?php echo $data[0];?>" data-provide="typeahead"  value="" placeholder="" readonly>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nama_bidang" value="<?php echo $bidang;?>" data-provide="typeahead" data-items="4" placeholder="<?php echo $data[1];?>" required>
										...
										<div class="controls"]>
										<select name="id_prodi" id="select01" class="span6 chzn-select" required>
										...
										<?php
                                         ...
                                         <div class="form-actions">
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											if(isset($id_bidang,$nama_bidang,$id_prodi))
											{
											mysql_query("update BIDANGILMU set ID_PRODI='$id_prodi', NAMA_BIDANGILMU='$nama_bidang' where ID_BIDANGILMU='$id_bidang'");
