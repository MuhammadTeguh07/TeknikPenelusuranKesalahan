                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid">
                        ...
                        <!-- /block -->
										...
										<?php
										$dataa=mysql_fetch_array(mysql_query("select count(id_kota) as jumlah from kota;"));
										?>
					<div class="row-fluid">
                        <!-- block -->
                        <div class="block" >
                            ...
                            <div class="block-content collapse in">
                                      ...
                                      <fieldset>
										...
										<div class="form-actions">
                                          ...
                                          <button type="reset" class="btn">Batal</button>
											...
											{
											mysql_query("insert into kota values ('$id_kota','$nama_kota')");
                                ...
                                <div class="span12">
									<form method="POST" action="datamaster-kota-edit.php" >
						              ...
						              <?php
									  $no=1;
$str=mysql_query("SELECT * from kota");
