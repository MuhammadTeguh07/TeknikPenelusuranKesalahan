...
$a = "SELECT MAX(ID_PELAKSANAAN) FROM pelaksanaan_yudisium";
								...
								if($pelaksanaan <= 9) $pelaksanaan = "PEL000".$pelaksanaan;
								if($pelaksanaan <= 99 && $pelaksanaan > 9) $pelaksanaan = "PEL00".$pelaksanaan;
								if($pelaksanaan <= 999 && $pelaksanaan > 99) $pelaksanaan = "PEL0".$pelaksanaan;
								if($pelaksanaan <= 9999 && $pelaksanaan > 999) $pelaksanaan = "PEL".$pelaksanaan;
?>
<html class="no-js">
					...
					<div class="row-fluid">
                        ...
                        <div class="block" >
                            <div class="navbar navbar-inner block-header" >
                                <div class="muted pull-left" ><strong>Daftar Validasi Berkas Mahasiswa</strong></div>    
                            </div>
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
									...
									<form method="POST" action="daftar-berkas-mahasiswa.php" >
                                    <legend align="center">Daftar Validasi Berkas Mahasiswa</legend>
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
										...
										<tbody>
                                         <?php
									  $no=1;
$str=mysql_query("SELECT M.NIM, M.NAMA,  M.NO_TELP, M.FOTO, PE.STATUS_MHS
from mahasiswa m, pendaftaran pe, detail_berkas db
where db.id_pendaftaran=pe.id_pendaftaran and pe.status_mhs='0' and pe.nim=m.nim group by m.nim order by pe.status_mhs asc");
...
<td>
<?php if ($data[4]=='0') {
	echo 'Sudah Upload Berkas, Belum Divalidasi';
} else if ($data[4]=='1') {
...
<td><button class="btn btn-primary btn-mini" name="nim" value="<?php echo $data[0]; ?>">Validasi</button>
</td>
