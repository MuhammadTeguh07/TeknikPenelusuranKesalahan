...
@$nim=$_REQUEST['nim'];
@$data=mysql_fetch_array(mysql_query("SELECT M.NIM, M.NAMA, P.NAMA_PRODI, K.NAMA_KOTA, M.TGL_LAHIR, M.JENIS_KELAMIN, M.AGAMA, P.ID_PRODI, K.ID_KOTA, M.ALAMAT_RUMAH, M.JENIS_KELAMIN, M.EMAIL, M.NO_TELP, M.NO_HP
								...
								$d = mysql_fetch_array(mysql_query("SELECT ID_PEG, NAMA_PEG from tata_usaha 
								where ID_PEG='$idpeg'"));
                        ...
                        <div class="block" >
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
											...
											<legend ALIGN="CENTER">Edit Data Mahasiswa</legend>
											<form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                      
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">NIM</label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="nim" data-provide="typeahead" value="<?php echo $data[0];?>"  placeholder="NIM" required disabled>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="id_prodi" data-provide="typeahead" value="<?php echo $data[2];?>" data-items="4" placeholder="Nama Lengkap" required disabled>
										...
										<div class="control-group">
                                         <label class="control-label" for="date01">Tanggal Lahir</label>
                                          <div class="controls">
                                            <input type="date" class="span6" id="typeahead" value="<?php echo $data[4]; ?>" data-provide="typeahead" name="tgl_lahir" required >
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls" required>
                                            <label>
                                              <input type="radio" value="L" name="jk" <?php if($data[10]=="L"){ echo "checked";} else { echo "";} ?>  >
                                              Laki-laki
                                            </label>
											<label>
                                              <input type="radio" value="P" name="jk" <?php if($data[10]=="P"){ echo "checked";} else { echo "";} ?> >
                                             Perempuan
                                            </label>
                                          </div>
                                        </div>
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead" name="agama" data-provide="typeahead" value="<?php echo $data[6];?>" data-items="4" placeholder="Agama" required disabled>
...
@$jk=$_REQUEST['jk'];
if (isset($nama)){
mysql_query("UPDATE `mahasiswa` SET `ID_KOTA`='$id_kota',`NAMA`='$nama',`JENIS_KELAMIN`='$jk',`TGL_LAHIR`='$tgl_lahir' WHERE NIM='$nim'");
