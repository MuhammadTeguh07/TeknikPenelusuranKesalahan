...
session_start();
 ...
 @$pendaftaran=$_REQUEST['pendaftaran'];
	...
	$period = $countdown[2];
 @$date2=date('Y-m-d');
  $pelaksanaan = mysql_query ("INSERT INTO `detail_pelaksanaan`(`ID_PELAKSANAAN`, `ID_PENDAFTARAN`, `TGL_KEPUTUSAN_YUDISIUM`, `STATUS_LULUS`, `ID_DETAIL_PELAKSANAAN`) VALUES ('$period','$pendaftaran','$date2','1', '$detail')")or die (mysql_error());
...
echo("<META HTTP-EQUIV=\"Refresh\"CONTENT=\"2;URL=proses-penerimaan-yudisium.php?nim=$nim&detail=$detail\">");
 //echo $nim;
?>