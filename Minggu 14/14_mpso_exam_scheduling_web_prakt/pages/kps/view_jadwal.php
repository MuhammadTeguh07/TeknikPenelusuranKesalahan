...
echo "</thead>";
echo "<tbody>";
$sql = mysql_query("select pj.kodejadwal, p.namapegawai, s.namasemester, t.tahunajaran, pj.status from penjadwalan pj, pegawai p, semester s, tahunajaran t where pj.nip=p.nip and pj.kodesemester=s.kodesemester and pj.kodethnajaran=t.kodethnajaran") or die (mysql_error());
