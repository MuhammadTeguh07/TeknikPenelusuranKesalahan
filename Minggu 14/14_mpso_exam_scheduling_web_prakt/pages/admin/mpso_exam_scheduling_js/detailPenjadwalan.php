...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                   <h1 class="page-header">DETAIL JADWAL UJIAN TENGAH SEMESTER </br> Semester Gasal 2016-2017</h1>
...
$sql = mysqli_query($koneksi,"SELECT * FROM slotisi") or die (mysqli_error($koneksi));
...
?>
    <tr>
        <td> <?php echo $no."."; ?> </td>
        <td><?php echo $row['noruang']; echo ' - '; echo $row['nohari']; echo ' - '; echo $row['nojam'];?> </td>
        <td><?php echo $row['KODEMATKUL'];?></td>
		<td><?php echo $row['NIPDosen1']; echo ' - '; echo $row['NIPDosen2'];?></td>
        <td><?php echo $row['NIPpeg1']; echo ' - '; echo $row['NIPpeg2'];?></td>
