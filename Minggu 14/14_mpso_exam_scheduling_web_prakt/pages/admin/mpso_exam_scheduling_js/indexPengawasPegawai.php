...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pengawas - Pegawai</h1>
                </div>
                <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Masukkan Data Pegawai Pengawas Ujian
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="insertPengawasPegawai.php" style="font-size:16px">
...
<select class="form-control" name="pegawai" required>
    <option value="-" selected="selected">-- Pilih --</option>
		...
		$querythn = mysqli_query($koneksi,"SELECT NIP,NAMAPEGAWAI FROM pegawai WHERE KODEJABATAN = 'jab001'") or die (mysqli_error());		
...
$sql = mysqli_query($koneksi,"SELECT p.nip, p.namapegawai, t.KODETHNAJARAN, s.KODESEMESTER, pp.uts_or_uas FROM pegawai p,
tahunajaran t, semester s, pengawaspegawai pp WHERE pp.nip=p.nip AND pp.kd_thn_ajaran=t.KODETHNAJARAN
AND pp.kd_semester=s.KODESEMESTER") or die (mysqli_error($koneksi));
...
?>
    <tr>
        ...
        <td>
            <a href="deletePengawasPegawai.php?nip=<?php echo $row['nip'];?>&kd_thn_ajar=<?php echo $row['KODETHNAJARAN'];?>&kd_semester=<?php echo $row['KODESEMESTER'];?>"><button> Hapus</button></a>
        </td>
    </tr>
<?php
}
