...
$sql = mysqli_query($koneksi,"select dt.kodejadwal, pj.kodethnajaran, pj.kodesemester, p.namaprodi, pj.status from detailjadwal dt, penjadwalan pj, prodi p where dt.kodejadwal=pj.kodejadwal and dt.kodeprodi=p.kodeprodi group by dt.iddetail") or die (mysqli_error($koneksi));
@$t = $_GET['t'];
@$tt = $_GET['tt'];

if(isset($t) && isset($tt) && $t=='-' && $tt=='-'){
$sql = mysqli_query($koneksi,"select dt.kodejadwal, pj.kodethnajaran, pj.kodesemester, p.namaprodi, pj.status from detailjadwal dt, penjadwalan pj, prodi p where dt.kodejadwal=pj.kodejadwal and dt.kodeprodi=p.kodeprodi group by dt.iddetail") or die (mysqli_error($koneks));
} else if(isset($t) && isset($tt) && $t!='-' && $tt=='-'){
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">LAPORAN JADWAL SEMESTER</h1>
                </div>
