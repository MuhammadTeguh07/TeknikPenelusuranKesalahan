                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../mpso_exam_scheduling_js/insertview_ruangujian.php">Ruang Ujian</a>
                                </li>
                                <li>
                                    <a href="../mpso_exam_scheduling_js/insertview_labkomujian.php">Labkom Ujian</a>
                                </li>
                                <li>
                                    <a href="../mpso_exam_scheduling_js/insertview_pengawasdosen.php">Pengawas Dosen</a>
                                </li>
                                <li>
                                    <a href="../mpso_exam_scheduling_js/insertview_pengawaspegawai.php">Pengawas Pegawai</a>
                                </li>
                                <li>
                                    <a href="../mpso_exam_scheduling_js/mpso_penjadwalan.php">Penjadwalan dengan M-PSO</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
