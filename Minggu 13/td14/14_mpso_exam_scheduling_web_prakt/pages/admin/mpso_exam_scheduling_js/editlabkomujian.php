...
<?php
$baca_ruang = mysqli_query($koneksi,"SELECT * FROM labkomujian where KODELABUJIAN='$_GET[kodelabujian]'");
$row = mysqli_fetch_array($baca_ruang);
?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                   <h1 class="page-header">Ruang Ujian</h1>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="update_labkomujian.php" style="font-size:16px">
<div class="form-group">
<label>KODE Labkom Ujian</label>
<input class="form-control" type="text" name="kodelabujian" maxlength="20" autofocus required value="<?php  echo $row[0]; ?>" readonly/><br>
</div>
<div class="form-group">
<label>Kode Labkom</label>
<input class="form-control" type="text" name="kodelab" maxlength="20" required value="<?php  echo $row[1]; ?>"/>
<!-- <select class="form-control" name="kodelab" id="kodelab" required>
     <option value="null" selected="selected">-- Pilih --</option>
                <?php				
		$q5 = mysqli_query($koneksi,"SELECT * FROM labkom order by namalab") or die (mysql_error());		
...
<input class="form-control" type="text" name="kodethnajaran" maxlength="20" required value="<?php  echo $row[2]; ?>"/>
...
<input class="form-control" type="text" name="kodesemester" maxlength="20" required value="<?php  echo $row[3]; ?>"/>
...
<a href="insertview_labkomujian.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</button></a>
</form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
