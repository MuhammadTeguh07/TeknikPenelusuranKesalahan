...
//OperasiVektor.tampilVektor(vHas2);document.write("<br />");		
	...
	/*
		buat Mat Slot Final
	*/
	buatMatSlotFinal : function(matSlotIsi,matSlotIsiP, mkJalanTeoriUjian, mkJalanPraktekUjian,nilFitBest,kdthnajaran, kdsemester, kdmasaujian){
		...
		console.log("selesai menghitung:v");
//document.write("=== nBarMKP : "+nBarMKP+" dan nBarMKT : "+nBarMKT+" <br />");
//document.write("=== nBarT : "+nBarT+" dan nBarP : "+nBarP+" <br />");		
		var mNolT = OperasiMatriks.isiAwalMatriks(nBarT ,nKolMK+3);
		var mNolP = OperasiMatriks.isiAwalMatriks(nBarP ,nKolMK+3);		
		var iMK;
		console.log("selesai masuk di isiawal");
...
//document.write("===== mkJalanTeoriUjian[i][j] : "+mkJalanTeoriUjian[iMK][j]+" <br />");					
		...
		console.log("selesai for pertama");
