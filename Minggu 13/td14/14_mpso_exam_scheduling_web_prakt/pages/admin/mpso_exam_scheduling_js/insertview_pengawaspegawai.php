                   ...
                   <h1 class="page-header">Pengawas - Pegawai</h1>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="insert_pengawaspegawai.php" style="font-size:16px">
<div class="form-group">
<label>Pegawai</label>
<select class="form-control" name="nip" id="nip" required>
     <option value="null" selected="selected">-- Pilih --</option>
                <?php               
        $q5 = mysqli_query($koneksi,"SELECT * FROM pegawai WHERE kodejabatan='jab001'") or die (mysql_error());        
...
echo "</thead>";
echo "<tbody>";
$sql = mysqli_query($koneksi, "SELECT pd.*,pegawai.NAMAPEGAWAI FROM pengawaspegawai pd JOIN pegawai ON pegawai.NIP = pd.NIP") or die (mysqli_error($koneksi));
