                   ...
                   <h1 class="page-header">Ruang Ujian</h1>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="insert_labkomujian.php" style="font-size:16px">
<div class="form-group">
<label>KODE Labkom Ujian</label>
<input class="form-control" type="text" name="kodelabujian" maxlength="20" autofocus required value="<?php  echo $urut_kd; ?>" readonly/><br>
</div>
<div class="form-group">
...
echo "</thead>";
echo "<tbody>";
$sql = mysqli_query($koneksi, "SELECT l.*,lab.NAMALAB FROM labkomujian l JOIN labkom lab ON lab.KODELAB = l.KODELAB") or die (mysqli_error($koneksi));
...
?>
    <tr>
        ...
        <td><a href="editlabkomujian.php?kodelabujian=<?php echo $row['KODELABUJIAN']; ?>"><button> Ubah</button></a>
