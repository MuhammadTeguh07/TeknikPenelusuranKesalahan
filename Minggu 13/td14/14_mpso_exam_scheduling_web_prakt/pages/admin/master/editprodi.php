...
<?php include("../sidebaradmin.php")?>
        ...
        <div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">UBAH DATA PRODI</h1>
                </div>
                <div class="row col-lg-6">
                <?php
$sql = mysqli_query($koneksi,"SELECT PRODI.KODEPRODI,PRODI.NAMAPRODI,FAKULTAS.NAMAFAKULTAS,PRODI.KODEFAKULTAS FROM PRODI INNER JOIN FAKULTAS ON PRODI.KODEFAKULTAS=FAKULTAS.KODEFAKULTAS WHERE PRODI.KODEPRODI='$_GET[kodeprodi]'") or die (mysqli_error());
mysqli_select_db($koneksi, $nama_db) or die("Gagal memilih database!");
$row=mysqli_fetch_array($sql);
?>
<form method="post" action="updateprodi.php" style="font-size:16px">
<div class="form-group">
<label>Kode Prodi</label>
<input class="form-control" type="text" name="kodeprodi" value="<?php echo $row['KODEPRODI']; ?>" disabled/><br>
<input type="hidden" name="kodeprodis" value="<?php echo $row['KODEPRODI']; ?>"/>
</div>
<div class="form-group">
<label>Nama Prodi</label>
<input class="form-control" type="text" name="namaprodi" value="<?php echo $row['NAMAPRODI']; ?>" required/><br>
</div>
<div class="form-group">
...
<a href="insertview_prodi.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</button></a>
</form>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
