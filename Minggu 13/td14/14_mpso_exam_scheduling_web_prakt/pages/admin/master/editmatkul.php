...
AND MATAKULIAH.KODEPRODI=PRODI.KODEPRODI WHERE KODEMATKUL='$_GET[kodematkul]'") or die (mysqli_error($koneksi));
...
<select class="form-control dependant" name="kodekataup" id="" required>
	 <option value="<?php echo $row['KATAUP']; ?>" selected="selected">-- <?php 
...
<a href="insertview_matkul.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</button></a>
</form>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
