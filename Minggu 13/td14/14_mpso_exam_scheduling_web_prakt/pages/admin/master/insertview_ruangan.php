...
<?php
$baca_ruang = mysqli_query($koneksi,"SELECT * FROM ruangan ORDER BY koderuang DESC limit 1");
$kd_ruang_row = mysqli_fetch_array($baca_ruang);
if(count($kd_ruang_row) == 0) $urut_kd = "00"."1";
else {
	$kd_ruang = $kd_ruang_row[0];
	$urut_kd = intval(substr($kd_ruang,3,strlen($kd_ruang)))+1;
}
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form method="post" action="insertruangan.php" style="font-size:16px">
<div class="form-group">
<label>KODE RUANG</label>
<input class="form-control" type="text" name="koderuangan" maxlength="20" autofocus required value="rng<?php  echo $urut_kd; ?>" readonly/><br>
</div>
<div class="form-group">
<label>NAMA RUANG</label>
<input class="form-control" type="text" name="namaruangan" placeholder="masukkan nama ruangan" maxlength="10" autofocus required/><br>
</div>
<div class="form-group">
<label>KAPASITAS RUANG</label>
<input class="form-control" type="number" name="kapasitasruangan" placeholder="masukkan kapasitas ruang" maxlength="11" required/><br>
</div>
<div class="form-group">
<label>KAPASITAS UJIAN</label>
<input class="form-control" type="number" name="kapasitasruangujian" placeholder="masukkan kapasitas Ujian" maxlength="11" required/><br>
</div>
...
echo "</thead>";
echo "<tbody>";
$sql = mysqli_query($koneksi,"SELECT KODERUANG,NAMARUANGAN,KAPASITASRUANG,KAPASITASUJIAN FROM RUANGAN") or die (mysqli_error());
...
?>
    <tr>
        ...
        <td><a href="editruangan.php?koderuangan=<?php echo $row['KODERUANG']; ?>"><button> Ubah</button></a>
            <a href="deleteruangan.php?koderuangan=<?php echo $row['KODERUANG']; ?>"><button> Hapus</button></a>
        </td>
    </tr>
<?php
}
