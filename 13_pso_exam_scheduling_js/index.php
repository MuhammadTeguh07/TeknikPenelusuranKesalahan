...
<script type = "text/javascript"> 
	...
	var matJabatan = JSON.parse(echo json_encode($mat_jabatan_php)); 	
	var matKelas = JSON.parse(echo json_encode($mat_kelas_php));	
	var matProdi = JSON.parse(echo json_encode($mat_prodi_php));	 
...
var php_data = "("+arrJsToPhp(matSlotFinal)+")";
	...
	$.ajax({
		type: 'POST',
		url: '/program_json_js_to_php_use_ajax_php7/1_process_data_in_php.php',  
